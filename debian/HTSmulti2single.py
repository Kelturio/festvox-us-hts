#!/usr/bin/python3
# (c) Peter Drysdale
# https://github.com/peterdrysdale/bellbird_extras
...
# Usage: HTSmulti2single dir_name_of_voice sampling_frequency frame_period alpha output_file
...
# Parse argv
    ...
    if not output_file.endswith(".htsvoice"):
        output_file = output_file + ".htsvoice"
...
# Append data segment to header in voice file
    with open(output_file, 'a+b') as fp:
        fp.write(data_seg)
